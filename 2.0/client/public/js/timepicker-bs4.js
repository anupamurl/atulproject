	...
	*/
	...
	function updatePicker($input)
	{
		...
		var html = '<div class="clock-input' + (clock_enabled ? '' : ' d-none') + '">'
			...
			+ '<div><button type="button" class="btn btn-secondary mx-1 cancel-btn" data-dismiss="popover">Cancel</button><button type="button" class="btn mx-1 submit-btn">OK</button></div>'
			+ '</div>';
